-- Japanese Real Estate Scraper Database Schema
-- This schema defines the structure for storing scraped property data

-- Create database (run manually if needed)
-- CREATE DATABASE japanese_real_estate_scraper;
